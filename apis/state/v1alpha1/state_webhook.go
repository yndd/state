...
//+kubebuilder:webhook:path=/mutate-state-nddp-yndd-io-v1alpha1-state,mutating=true,failurePolicy=fail,sideEffects=None,groups=state.nddp.yndd.io,resources="*",verbs=create;update,versions=v1alpha1,name=mutate.srl3.nddp.yndd.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-state-nddp-yndd-io-v1alpha1-state,mutating=false,failurePolicy=fail,sideEffects=None,groups=srl3.nddp.yndd.io,resources="*",verbs=create;update,versions=v1alpha1,name=validate.srl3.nddp.yndd.io,admissionReviewVersions=v1
...
func (r *State) ValidateCreate() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "state.nddp.yndd.io", Kind: "State"},
		r.Name, allErrs)
}
